                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly value="{{$coa->account_code}}" type="text"
                                                    id="projectinput1" class="form-control validate"
                                                    placeholder="First Name" name="account_code" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="projectinput2" class="form-control validate"
                                                    ...
                                                    value="{{$coa->account_title}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="parent_code" id=""
                                                    ...
                                                    <option value="{{$coa->parent_code}}" readonly>{{$coa->parent_code}}
                                                    </option>
                                                    @foreach($allCoa as $co)
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status == 200) {
                    Swal.fire(
                        'Update!',
                        'Chart Account Update Successfully!',
                        'success'
                    ).then((result) => {
