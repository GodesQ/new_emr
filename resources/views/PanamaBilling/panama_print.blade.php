                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">INVOICE: <span
                                                style="border: none; border-bottom: 1px solid black;">{{ $invoice_number }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        @forelse($collected_patient as $patient)
                                            <tr>
                                                ...
                                                <td valign="top" align="left">
                                                    {{ optional($patient->patient)->lastname }}</td>
                                                <td valign="top" align="left">
                                                    {{ optional($patient->patient)->firstname }}</td>
                                                <td valign="top" align="left" class="brdRight">
                                                    {{ optional($patient->patient)->middlename }}</td>
                                                <td valign="top" align="left" class="brdRight">
                                                    {{ $patient->panama_certno }}</td>
                                                <td valign="top" align="left" class="brdRight">
                                                    <?php
                                                    $total += 20;
                                                    echo '$ 20.00';
                                        ...
                                        <tr>
                                            ...
                                            <td class="brdTop brdRight" colspan="1">
                                                ...
                                                @else
                                                    @if ($currency == 'Pesos')
                                                        <div>$
                                                            {{ optional($agency)->id == 22 ? number_format($sub_amount, 2) : number_format($amount, 2) }}
                                                        </div>
